...
angular.module('ngCart', ['ngCart.directives'])
        ...
        .service('ngCart', ['$rootScope', 'ngCartItem', 'store', function ($rootScope, ngCartItem, store) {
                ...
                this.setTaxRate = function (taxRate) {
                    this.$cart.taxRate = +parseFloat(taxRate).toFixed(number_decimal);
                ...
                this.getTax = function () {
                    return +parseFloat(((this.getSubTotal() / 100) * this.getCart().taxRate)).toFixed(number_decimal);
                };
                ...
                this.getSubTotalCero = function () {
                    ...
                    return +parseFloat(total).toFixed(number_decimal);
                };
                ...
                this.getSubTotalDoce = function () {
                    ...
                    return +parseFloat(total - this.getCart().shipping + this.getCart().taxRate).toFixed(number_decimal);
                };
                ...
                this.totalCero = function () {
                    return +parseFloat(this.getSubTotalCero()).toFixed(number_decimal);
                };

                this.totalDoce = function () {
                    return +parseFloat(this.getSubTotalDoce()).toFixed(number_decimal);
                };

                this.Subtotal = function () {
                    return +parseFloat(this.getSubTotalCero() + this.getSubTotalDoce()).toFixed(number_decimal);
                };

                this.Recargo = function () {
                    return +parseFloat(0 + this.getCart().taxRate).toFixed(number_decimal);
                };

                this.Descuento = function () {
                    return +parseFloat(0 + this.getCart().shipping).toFixed(number_decimal);/*this.getSubTotal() + */
                };

                this.SubtotalNeto = function () {
                    //return +parseFloat(this.getSubTotalCero() + this.getSubTotalDoce()).toFixed(number_decimal);
                    return +parseFloat(this.getSubTotal()).toFixed(number_decimal);
                };

                this.ICE = function () {
                    return +parseFloat(0).toFixed(number_decimal);
                };

                this.IVA = function () {
                    return +parseFloat(this.getSubTotalIVA()).toFixed(number_decimal);
                };

                this.Total = function () {
                    return +parseFloat(this.getSubTotalCero() + this.getSubTotalDoce() + this.getSubTotalIVA()).toFixed(number_decimal);
                };

                this.totalBienes = function () {
                    return +parseFloat(this.getBienes()).toFixed(number_decimal);
                };

                this.totalServicios = function () {
                    return +parseFloat(this.getServicios()).toFixed(number_decimal);
                };
        ...
        .factory('ngCartItem', ['$rootScope', '$log', function ($rootScope, $log) {
                ...
                item.prototype.getTotalCero = function () {
                    ...
                    if (parseInt(this._data.porcentaje) === 0) {
                        rta = +parseFloat(this.getQuantity() * this.getPrice()).toFixed(number_decimal);
                    }
                    return rta;
                };
                ...
                item.prototype.getTotalDoce = function () {
                    var rta = 0;
                    if (parseInt(this._data.porcentaje) === parseInt(this._data.iva_calc)) {
                        rta = +parseFloat(this.getQuantity() * this.getPrice()).toFixed(number_decimal);
                    }
                    return rta;
                };
                ...
                item.prototype.getSubTotal = function () {
                    var rta = 0;
                    rta = +parseFloat(this.getTotalCero() + this.getTotalDoce()).toFixed(number_decimal);
                    return rta;
                };

                item.prototype.getTotal = function () {
                    return +parseFloat(this.getQuantity() * this.getPrice()).toFixed(number_decimal);
                };
