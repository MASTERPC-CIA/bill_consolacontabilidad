...
angular.module('ngCart', ['ngCart.directives'])
        ...
        .service('ngCart', ['$rootScope', 'ngCartItem', 'store', function ($rootScope, ngCartItem, store) {
                ...
                this.$restore = function (storedCart) {
                    ...
                    angular.forEach(storedCart.items, function (item) {
                        _self.$cart.items.push(new ngCartItem(item._id, item._name, item._price, item._quantity, item._prendas, item._data));
                    });
                    this.$save();
                };
        ...
        .factory('ngCartItem', ['$rootScope', '$log', function ($rootScope, $log) {
                ...
                var item = function (id, name, price, quantity, data) {
                    if (data) {
                        if (data.meses_garantia) {
                            this.setPrendas(data.meses_garantia);
                        }
                    }
                    this.setId(id);
                    this.setName(name);
                ...
                item.prototype.setPrendas = function (prendas) {
                    if (prendas)
                        this._prendas = prendas;
                    else {
                        $log.error('A prendas must be provided');
                    }
                };
                item.prototype.getPrendas = function () {
                ...
                item.prototype.get_iva_calc = function () {
                    ...
                    rta = this._data.porcentaje;//+parseFloat(this.getQuantity() * this.getPrice()).toFixed(4);
                    //}
                    return rta;
                };
