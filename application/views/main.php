...
<head>
    ...
    <link href="<?php base_url('assets/js/angularjs/toaster.css'); ?>" rel="stylesheet">
    ...
    <script src="<?php echo base_url('assets/js/angularjs/angular-route.min.js'); ?>"></script>
    <script src="<?php echo base_url('assets/js/angularjs/ui-bootstrap-tpls-0.14.3.min.js'); ?>"></script>
    <script src="<?php echo base_url('assets/js/angularjs/toaster.js'); ?>"></script>
